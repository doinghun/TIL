...
module.exports = {
  someSidebar: {
    ...
    Programming: [
      {
        JavaScript: [
          ...
          "js-memory-model",
          "js-regex",
          "js-making-cli-app-with-inquirerJS",
        ],
        ...
        DevOps: [
          ...
          "devops-dockerise-react",
          "devops-container-orchestration",
          "devops-prettier-setup-troubleshooting",
        ],
        Cloud: ["cloud-iam"],
        Python: [
          "python-anaconda",
    ...
    Finance: ["finance-per", "finance-beating-the-market"],
  },
}
